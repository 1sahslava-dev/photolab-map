...
// заданы явно правкой 17 именно для этого узкого места интерфейса.
...
export default function JourneySteps({ nodes, selectedNodeId, onSelectNode }) {
      ...
      {nodes.map((node, i) => {
        ...
        return (
          ...
          >
            ...
            {LESSON_SHORT_TITLES[node.lessonLink] && (
              <span className="journey-step-title">{LESSON_SHORT_TITLES[node.lessonLink]}</span>
            )}
